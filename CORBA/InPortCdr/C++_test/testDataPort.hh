...
#ifndef __testDataPort_hh__
#define __testDataPort_hh__
...
# define USE_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif
#ifndef  USE_core_stub_in_nt_dll
# define USE_core_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif
#ifndef  USE_dyn_stub_in_nt_dll
# define USE_dyn_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif
...
#ifndef __testOpenRTM_mInPortCdr__
#define __testOpenRTM_mInPortCdr__
  class InPortCdr;
  ...
  public:
    // IDL operations
    PortStatus put(const ::testOpenRTM::CdrData& data);
    PortStatus put(const cdrMemoryStream& data);

    // Constructors
    inline _objref_InPortCdr() : _shortcut(0) { _PR_setobj(0); }  // nil
  ...
  public:
    ...
    virtual PortStatus put(const ::testOpenRTM::CdrData& data) = 0;
    virtual PortStatus put(cdrMemoryStream& data) = 0;
    virtual PortStatus put(cdrStream& data) = 0;
...
#ifndef __testOpenRTM_mOutPortCdr__
#define __testOpenRTM_mOutPortCdr__
  class OutPortCdr;
  ...
  public:
    // IDL operations
    PortStatus get(::testOpenRTM::CdrData_out data);

    // Constructors
    inline _objref_OutPortCdr() : _shortcut(0) { _PR_setobj(0); }  // nil
  ...
  public:
    ...
    virtual PortStatus get(::testOpenRTM::CdrData_out data) = 0;
...
_CORBA_MODULE POA_testOpenRTM
_CORBA_MODULE_BEG

  class InPortCdr :
    public virtual testOpenRTM::_impl_InPortCdr,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~InPortCdr();

    inline ::testOpenRTM::InPortCdr_ptr _this() {
      return (::testOpenRTM::InPortCdr_ptr) _do_this(::testOpenRTM::InPortCdr::_PD_repoId);
    }
  };

  class OutPortCdr :
    public virtual testOpenRTM::_impl_OutPortCdr,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~OutPortCdr();

    inline ::testOpenRTM::OutPortCdr_ptr _this() {
      return (::testOpenRTM::OutPortCdr_ptr) _do_this(::testOpenRTM::OutPortCdr::_PD_repoId);
    }
  };
...
inline void operator >>=(testOpenRTM::PortStatus _e, cdrStream& s) {
...
inline void operator <<= (testOpenRTM::PortStatus& _e, cdrStream& s) {
  ::CORBA::ULong _0RL_e;
  ::operator<<=(_0RL_e,s);
  if (_0RL_e <= testOpenRTM::UNKNOWN_ERROR) {
    _e = (testOpenRTM::PortStatus) _0RL_e;
  }
  else {
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, testOpenRTM::PortStatus& _s);

void operator<<=(::CORBA::Any& _a, const testOpenRTM::CdrData& _s);
void operator<<=(::CORBA::Any& _a, testOpenRTM::CdrData* _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, testOpenRTM::CdrData*& _sp);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, const testOpenRTM::CdrData*& _sp);

void operator<<=(::CORBA::Any& _a, testOpenRTM::InPortCdr_ptr _s);
void operator<<=(::CORBA::Any& _a, testOpenRTM::InPortCdr_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, testOpenRTM::InPortCdr_ptr& _s);

void operator<<=(::CORBA::Any& _a, testOpenRTM::OutPortCdr_ptr _s);
void operator<<=(::CORBA::Any& _a, testOpenRTM::OutPortCdr_ptr* _s);
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, testOpenRTM::OutPortCdr_ptr& _s);



inline void
testOpenRTM::InPortCdr::_marshalObjRef(::testOpenRTM::InPortCdr_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}

inline void
testOpenRTM::OutPortCdr::_marshalObjRef(::testOpenRTM::OutPortCdr_ptr obj, cdrStream& s) {
  omniObjRef::_marshal(obj->_PR_getobj(),s);
}



#ifdef   USE_stub_in_nt_dll_NOT_DEFINED_testDataPort
# undef  USE_stub_in_nt_dll
# undef  USE_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif
#ifdef   USE_core_stub_in_nt_dll_NOT_DEFINED_testDataPort
# undef  USE_core_stub_in_nt_dll
# undef  USE_core_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif
#ifdef   USE_dyn_stub_in_nt_dll_NOT_DEFINED_testDataPort
# undef  USE_dyn_stub_in_nt_dll
# undef  USE_dyn_stub_in_nt_dll_NOT_DEFINED_testDataPort
#endif

#endif  // __testDataPort_hh__
